...
const App: React.FC = () => {
  ...
  const navItemClass = (section: string) => 
    `transition-all duration-300 font-black text-[9px] sm:text-[10px] md:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em] hover:text-white cursor-pointer px-1.5 sm:px-2 py-1 ${
      activeSection === section ? 'text-white border-b-2 border-sky-400' : 'text-white/50'
    }`;
          ...
          <div className="relative group mx-auto max-w-xs sm:max-w-sm lg:max-w-none">
            ...
            <div className="glass p-3 sm:p-4 md:p-6 rounded-[2.5rem] sm:rounded-[3rem] md:rounded-[5rem] relative shadow-3xl bg-slate-900/40">
              <div className="aspect-[4/5] rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[4rem] overflow-hidden border border-white/10">
                 <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=1000" alt="Earbaj" className="w-full h-full object-cover grayscale-[0.2]" />
              </div>
